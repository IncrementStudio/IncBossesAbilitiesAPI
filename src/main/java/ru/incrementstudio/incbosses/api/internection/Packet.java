...
public class Packet {
    public static class API {
        ...
        public static class Boss {
            ...
            public static final int GET_BOSS_BAR = 8;
            public static final int GET_DAMAGE_MAP = 9;
            public static final int GET_DEATH_TYPE = 10;
            public static final int GET_SPAWN_TYPE = 11;
        }
        ...
        public static class PhaseData {
            ...
            public static final int IS_FLAG_CHAT_START_NOTIFICATION = 2;
            public static final int IS_FLAG_CLEAR_EFFECTS_ON_END = 3;
        }
    }
}
